...
describe('Containers/Match/StadiumTooltip', () => {
  ...
  const stadiumWithPhoto = {
    ...
    photo: {
      ...
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/RUS-2016-Aerial-SPB-Krestovsky_Stadium_02.jpg/512px-RUS-2016-Aerial-SPB-Krestovsky_Stadium_02.jpg',
    },
  };
  ...
  it('renders correctly', () => {
    const tree = renderer.create(
      <StadiumTooltip stadium={stadiumWithPhoto} />
    ).toJSON();
  ...
  it('render with no image if not provided', () => {
    const tree = renderer.create(
      <StadiumTooltip stadium={stadium} />
    ).toJSON();
    expect(tree).toMatchSnapshot();
  });
});
